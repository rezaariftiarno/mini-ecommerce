...
<div class="card mx-auto">
    ...
    <div class="carousel-inner">
        ...
        <img class="d-block w-100" src="../assets/img/1-1.gif" alt="First slide">
        </div>
        <div class="carousel-item">
        <img class="d-block w-100" src="../assets/img/1-2.gif" alt="Second slide">
        </div>
        <div class="carousel-item">
        <img class="d-block w-100" src="../assets/img/1-3.gif" alt="Third slide">
        </div>
        <div class="carousel-item">
        <img class="d-block w-100" src="../assets/img/1-4.gif" alt="Third slide">
        </div>
    </div>
